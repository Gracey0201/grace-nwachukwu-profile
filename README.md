...
## Education
- [University of Lagos](https://unilag.edu.ng/) - Master’s in Environmental Science & Policy, Master’s in Geographic Information Science and Cartography
- [Clark University](https://www.clarku.edu/) - Bachelor’s in Marine Biology.
...
- Water Quality Assessment & Aquatic Ecosystems  
- Climate and Land Use Change Impacts  
- Public Health & Environmental Hazards  
- Conservation GIS & Sustainable Resource Management
...
- **Remote Sensing:** Sentinel-2, Landsat, NDWI/NDTI/NDCI indices  
- **Programming & Data Science:** Python (xarray, Dask, pandas, matplotlib), R  
- **Database Management:** SQL, PostgreSQL, data normalization, spatial queries  
- **Visualization & Reporting:** JupyterLab, Cartopy, Matplotlib, Plotly  
